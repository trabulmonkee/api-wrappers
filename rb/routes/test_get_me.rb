...
class TS_BAU_GET_ME < ParallelTestCases
    def setup
        @URL = "#{ENV['BAU_BASE_URL']}/get-me"
        @DEFAULT_ERR_BODY = JSON.parse(ENV['DEFAULT_ERR_BODY']).to_json
        @EXPECTED_BODY = '{"message":"got"}'
