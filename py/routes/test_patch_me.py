...
class TestBAUPatchMe:
    @pytest.fixture
    def bau(self, cfg):
        self.URL = cfg["base_url"] + '/patch-me'
        self.DEFAULT_ERR_BODY = cfg["default_err_body"]
        self.EXPECTED_BODY = {"message": "patched"} 
        self.EXPECTED_ALLOW_VALUES = ['PATCH', 'OPTIONS']
        return BaseApiUtils(cfg)

    def test_patch_me_delete(self, bau):
    ...
    def test_patch_me_get(self, bau):
    ...
    def test_patch_me_head(self, bau):
    ...
    def test_patch_me_options(self, bau):
    ...
    def test_patch_me_patch(self, bau):
    ...
    def test_patch_me_post(self, bau):
    ...
    def test_patch_me_put(self, bau):
