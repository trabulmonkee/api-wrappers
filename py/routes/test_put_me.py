...
class TestBAUPutMe:
    @pytest.fixture
    def bau(self, cfg):
        self.URL = cfg["base_url"] + '/put-me'
        self.DEFAULT_ERR_BODY = cfg["default_err_body"]
        self.EXPECTED_BODY = {"message": "put"}
        self.EXPECTED_ALLOW_VALUES = ['PUT', 'OPTIONS']
        return BaseApiUtils(cfg)

    def test_put_me_delete(self, bau):
    ...
    def test_put_me_options(self, bau):
    ...
    def test_put_me_patch(self, bau):
