...
class TestBAUPostMe:
    @pytest.fixture
    def bau(self, cfg):
        self.URL = cfg["base_url"] + '/post-me'
        self.DEFAULT_ERR_BODY = cfg["default_err_body"]
        self.EXPECTED_BODY = {"message": "posted"}
        self.EXPECTED_ALLOW_VALUES = ['POST', 'OPTIONS']
        return BaseApiUtils(cfg)

    def test_post_me_delete(self, bau):
    ...
    def test_post_me_head(self, bau):
    ...
    def test_post_me_options(self, bau):
    ...
    def test_post_me_patch(self, bau):
    ...
    def test_post_me_post(self, bau):
