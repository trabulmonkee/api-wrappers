...
class TestBAUTeaMe:
    @pytest.fixture
    def bau(self, cfg):
        self.URL = cfg["base_url"] + '/tea-me'
        self.DEFAULT_ERR_BODY = cfg["default_err_body"]
        self.EXPECTED_BODY = {"message": "delightful"} 
        self.EXPECTED_ALLOW_VALUES = ['HEAD', 'GET', 'OPTIONS']
        return BaseApiUtils(cfg)

    def test_tea_me_delete(self, bau):
    ...
    def test_tea_me_get(self, bau):
        rsp = bau.get_it(self.URL)
        bool, msg = bau.check_response_status_code(rsp=rsp, expected_status_code=418)
        assert bool, msg
    ...
    def test_tea_me_options(self, bau):
    ...
    def test_tea_me_patch(self, bau):
