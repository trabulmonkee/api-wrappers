...
class TestBAUDeleteMe:
    @pytest.fixture
    def bau(self, cfg):
        self.URL = cfg["base_url"] + '/delete-me'
        self.DEFAULT_ERR_BODY = cfg["default_err_body"]
        self.EXPECTED_BODY = {"message": "deleted"}
        self.EXPECTED_ALLOW_VALUES = ['DELETE', 'OPTIONS']
        return BaseApiUtils(cfg)

    def test_delete_me_delete(self, bau):
        rsp = bau.delete_it(self.URL)
        bool, msg = bau.check_response_status_code(rsp=rsp, expected_status_code=202)
        assert bool, msg
        bool, msg = bau.check_response_body(rsp=rsp, expected_body=self.EXPECTED_BODY)
        assert bool, msg
    ...
    def test_delete_me_get(self, bau):
    ...
    def test_delete_me_head(self, bau):
    ...
    def test_delete_me_options(self, bau):
    ...
    def test_delete_me_patch(self, bau):
    ...
    def test_delete_me_post(self, bau):
    ...
    def test_delete_me_put(self, bau):
